...
Setup Inicial
=============
--FOI RETIRADO O > ANTES DE MODULE E MAIN PARA QUE O CÓDIGO FUNCIONASSE
\begin{code}
module Aula03 where
...
--FOI RETIRADO O > ANTES DE MODULE E MAIN PARA QUE O CÓDIGO FUNCIONASSE (LINHA 19)
bools :: [Bool]
\begin{code}
bools :: [Bool]
bools = [False]
