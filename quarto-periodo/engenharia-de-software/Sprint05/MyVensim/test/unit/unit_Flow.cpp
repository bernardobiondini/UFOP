 ...
 * @param target
 */
UnitExponential::UnitExponential(string name, System* source, System* target)
...
void unit_Flow_constructor(){
    ...
    Flow *f1 = new UnitExponential("flow1", &s1, s2);
...
void unit_Flow_getName(){
    ...
    Flow *f1 = new UnitExponential("flow1", NULL, NULL);
...
void unit_Flow_getSource(){
    ...
    ImpSystem s1;
    Flow *f1 = new UnitExponential("", &s1, NULL);
...
void unit_Flow_getTarget(){
    ...
    System *s2 = new ImpSystem("system 2", 30);
    Flow *f1 = new UnitExponential("", NULL, s2);
...
void unit_Flow_setSource(){
    ...
    ImpSystem s1;
    Flow *f1 = new UnitExponential("", NULL, NULL);
...
void unit_Flow_execute(){
    ...
    UnitExponential* flow = new UnitExponential("Flow", system1, system2);
